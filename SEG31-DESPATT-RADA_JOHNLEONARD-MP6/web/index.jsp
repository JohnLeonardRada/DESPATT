...
<html lang="en" class="h-100">
  ...
  <body class="d-flex flex-column h-100">
	...
	<main class="flex-shrink-0">
	  <!-- JUMBOTRON -->
		 <div class="jumbotron bg-light p-5 rounded-lg m-0">
		  <h1 class="display-4">Welcome to SwallowTail Shop!</h1>
		  <p class="lead">Watcha lookin' for?</p>
		  <hr class="my-4">
		  <p><a class="btn btn-primary btn-lg" href="items.jsp" role="button">Check Items &raquo;</a></p>
		</div>
		...
		<!-- CREATOR -->
	     <section class="page-section" id="creator">
              ...
              <div class="text-center">
                  <div class="col-lg-20">
                      <div class="team-member">
                      	  <h5>The Creator</h5>
                          <img class="mx-auto rounded-circle" src="images/1.jpg" alt="" />
                          <h4>John Leonard M. Rada</h4>
              ...
              <div class="row">
                  <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">"Logic will get you from A to Z; imagination will get you everywhere."</p></div>
                  <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">-Albert Einstein</p></div>
              </div>
          </div>
        </section> 
