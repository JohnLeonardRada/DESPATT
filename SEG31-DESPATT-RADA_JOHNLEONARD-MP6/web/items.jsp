  ...
  <body class="d-flex flex-column h-100">
	...
	<main class="flex-shrink-0">
		...
		%>
		  ...
		  <div class="container">
		  	<div class="card">
			  <img class="card-img-top" src=<%= resultSet.getString("itemImage") %> alt="Card image cap">
			  <div class="card-body">
			   <form action="searchphone.action">
				    <h4 class="card-title"><%= resultSet.getString("itemName") %></h4>
				    <p class="card-text">
				      <b>Price: Php </b><%= resultSet.getDouble("itemPrice") %>
				    </p>
				    <input type="hidden" name="searchPhone" value="<%= resultSet.getString("itemName") %>">
			    ...
			    data-itemQuantity="<%=resultSet.getInt("itemQuantity")%>">
			    Add To Cart</button>
			  </div>
			</div>
		  </div>
