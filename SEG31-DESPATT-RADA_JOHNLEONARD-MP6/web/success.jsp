		...
		<div class="container">
		 	<div class="card text-center">
			  ...
			  <form action="index.jsp">
				  <div class="card-body">
				    <h5 class="card-title">Thank you for shopping in SwallowTail Shop!</h5>
				    <p class="card-text">Please come back again!</p>
				    <button type="submit" class="btn btn-outline-primary">Go Home!</button>
				  </div>
			  </form>	  
			</div>
	  	</div>
		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <button type="submit" class="btn btn-success" id="confirm-purchase">Checkout</button>
		      </div>
		      </form>
		    </div>
		  </div>
