...
public class CreateFilePDF implements DBOperation, Facade{
    	...
    	if (connection != null) {
	    	try {
		        ...
		        document.open();
			        ...
			        PreparedStatement pstmnt = connection.prepareStatement(GET_ORDERID);
    ...
    public static void sendAttachment(String FilePathing){  
		...
		try {
			...
			pdfAttachment.attachFile(FilePathing);
