...
<html lang="en" class="h-100">
  ...
  <body class="d-flex flex-column h-100">
	...
	<br>
	    ...
	    String sql = "select * from itemDB where itemName='"+search+"' ";
       ...
       <section class="page-section" id="item">
       	 <div class="container">
              ...
              <div class="results">
				...
				<div class="text-center">
					<div class="card mb-4">
						<img src= <%= resultSet.getString("itemImage") %> class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-title"><%= resultSet.getString("itemName") %></h5>
							<p class="card-text"><b>Product ID: </b><%= resultSet.getString("itemId") %></p>
							<p class="card-text"><b>Storage: </b><%= resultSet.getString("itemSpecs") %></p>
							<p class="card-text"><b>Camera:  </b><%= resultSet.getString("megaPixels") %></p>
							<p class="card-text"><b>Screen Size: </b><%= resultSet.getString("screenSize")%></p>
							<p class="card-text"><b>Price: </b><%= resultSet.getString("itemPrice")%></p>
							<button type="button" onClick = 'addItem(this)'  class="btn btn-outline-primary"
						    data-itemName="<%=resultSet.getString("itemName")%>"
						    data-itemPrice="<%=resultSet.getDouble("itemPrice")%>"
						    data-itemImage="<%=resultSet.getString("itemImage")%>">
						    Add To Cart</button>
						</div>
					</div>
	            </div>
